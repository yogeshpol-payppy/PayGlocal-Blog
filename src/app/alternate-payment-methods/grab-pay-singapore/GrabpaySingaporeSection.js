...
function GrabpaySingaporeSection()
{
    ...
    return(
        <>
        {/* Feature section */}
        <PaymentMethodPagesSection title={'GrabPay Singapore'} methodType={'Wallet'} cunsumerContry={'Singapore (SG)'} paymentCurrency={'Singapore Dollars (SGD)'} settlementCurrency={'Indian Rupees (INR)'} chargeback='No' minimunTransactionAmount={'SGD 5'} maximumTransactionAmount1={'SGD 3000'} timeout={'60 minutes'} />
...
export default GrabpaySingaporeSection;