...
function SofortSection()
{
    ...
    return(
        <>
        {/* Features section */}
        <PaymentMethodPagesSection title={'Sofort'} methodType={'Bank Transfer'} isMultipleConsumerContry={true} multipleConsumerContryValue={['Austria (AT)','Belgium (BE)','Germany (DE)','Netherlands (NL)','Italy (IT)','Poland (PL)','Spain (ES)','Switzerland (CH)']} isMultiplePaymentCurrencies={true} multiplePaymentCurrenciesValue={['Euro (EUR)','Pound Sterling (GBP)']} settlementCurrency={'Indian Rupees (INR)'} chargeback='No' minimunTransactionAmount={'EUR 5'} maximumTransactionAmount1={'EUR 5000'} timeout={'60 minutes'} />
