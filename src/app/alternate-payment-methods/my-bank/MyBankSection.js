...
function MyBankSection()
{
    ...
    return(
        <>
        {/* Features section */}
        <PaymentMethodPagesSection title={'MyBank'} methodType={'Bank Transfer'} cunsumerContry={'Italy (IT)'} paymentCurrency={'Euro (EUR)'} settlementCurrency={'Indian Rupees (INR)'} chargeback='No' minimunTransactionAmount={'EUR 5'} maximumTransactionAmount1={'EUR 9000'} timeout={'5 minutes'} />
