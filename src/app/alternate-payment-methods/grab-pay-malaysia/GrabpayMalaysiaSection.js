...
function GrabpayMalaysiaSection()
{
    ...
    return(
        ...
        <PaymentMethodPagesSection title={'GrabPay - Malaysia'} methodType={'Wallet'} cunsumerContry={'Malaysia (MY)'} paymentCurrency={'Malaysian Ringgit (MYR)'} settlementCurrency={'Indian Rupees (INR)'} chargeback='No' minimunTransactionAmount={'MYR 25'} maximumTransactionAmount1={'MYR 1500'} timeout={'180 minutes'} />
...
export default GrabpayMalaysiaSection;