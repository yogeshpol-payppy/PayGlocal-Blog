...
function EpsSection()
{
    ...
    return(
        <>
        {/* Feature section */}
        <PaymentMethodPagesSection title={'EPS'} methodType={'Bank Transfer'}  cunsumerContry={'Austria (AT)'} paymentCurrency={'Euro (EUR)'} settlementCurrency={'Indian Rupees (INR)'} chargeback='No' minimunTransactionAmount={'EUR 5'} maximumTransactionAmount1={'EUR 9000'} timeout={'60 minutes'} />
