...
function UPISection()
{
    ...
    return(
        <>
        {/* Features section */}
        <PaymentMethodPagesSection title={'United Payment Interface (UPI)'} methodType={'Bank Transfer'} cunsumerContry={'Indian (IN)'} paymentCurrency={'Indian Rupees (INR)'} settlementCurrency={'Indian Rupees (INR)'} chargeback='No' minimunTransactionAmount={'INR 10'} maximumTransactionAmount1={'Consumer Bank defines upper limit'} timeout={'5 minutes'} /> 
