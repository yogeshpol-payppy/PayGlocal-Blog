    ...
    return(
        ...
        <footer className="background-custom-grey900">
            ...
            <div className="max-w-6xl w-full flex flex-col  items-center gap-14 lg:gap-0 px-4 sm:px-10  lg:mx-auto ">
                ...
                <div className="flex flex-col-reverse lg:flex-row w-full lg:justify-between items-center lg:items-start ">
                    <div className="flex flex-col items-center lg:items-start   py-10 px-5 sm:p-10 lg:py-14  max-w-xl w-full">
                        <div className="mb-5"><Image src={Logo} width={224} height={40} alt='img' quality={100} className=''/></div>
                        <p className={"common-body3-text custom-text-grey500 font-medium "}>Copyright 2024. All Rights Reserved</p>
                    </div>
                ...
                <div className="common-body3-text custom-text-grey600 max-w-2xl text-center py-10 border-t border-dashed border-custom-grey200 ">All third-party logos and trademarks displayed on this website are for illustrative purposes only. Their appearance does not imply any endorsement, sponsorship or affiliation  between PayGlocal and the trademark owner / company / brand . All such trademarks are the property of their respective owners.</div>
